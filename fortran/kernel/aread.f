C Extracted kernel source. Original source: vendor/xfoil/src/aread.f
...
C------ less than four numbers... usual .dat labeled file
        ...
        IF(INFO.GT.0) THEN
         WRITE(99,*)
         WRITE(99,*) 'Labeled airfoil file.  Name:  ', NAME
        ENDIF
        ITYPE = 2
        REWIND(LU)
...
C------ four or more numbers... MSES or MISES file
        IF(INFO.GT.0) THEN
         WRITE(99,*)
         WRITE(99,*) 'MSES airfoil file.  Name:  ', NAME
        ENDIF
        ITYPE = 3
        ISPARS = LINE2
      ENDIF
