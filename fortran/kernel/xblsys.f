C Extracted kernel source. Original source: vendor/xfoil/src/xblsys.f
...
C
 100  CONTINUE
      WRITE(99,*) 'TRCHEK2: N2 convergence failed.'
      WRITE(99,6700) X1, XT, X2, AMPL1, AMPLT, AMPL2, AX, DA2
...
CCC       WRITE(99,*) 'BLVAR: Us clamped:', US2
       US2 = 0.98
       US2_U2 = 0.
       US2_T2 = 0.
       US2_D2 = 0.
...
CCC       WRITE(99,*) 'BLVAR: Wake Us clamped:', US2
       US2 = 0.99995
       US2_U2 = 0.
       US2_T2 = 0.
       US2_D2 = 0.
...
ccc      write(99,*) 'Cft Cfl Rt Hk:', CF2, CF2L, RT2, HK2, X2
         CF2     = CF2L
         CF2_HK2 = CF2L_HK2
         CF2_RT2 = CF2L_RT2
         CF2_M2  = CF2L_M2
...
C-       (this will only occur for unreasonably small Rtheta)
ccc       write(99,*) 'CDt CDl Rt Hk:', DI2, DI2L, RT2, HK2
          DI2    = DI2L
          DI2_S2 = 0.
...
C---- midpoint skin friction coefficient  (zero in wake)
      ...
      ELSE
       ...
       IF(CFML.GT.CFM) THEN
ccc      write(99,*) 'Cft Cfl Rt Hk:', CFM, CFML, RTA, HKA, 0.5*(X1+X2)
         CFM     = CFML
         CFM_HKA = CFML_HKA
         CFM_RTA = CFML_RTA
         CFM_MA  = CFML_MA
...
c           write(99,4455) rta, hka, gga, cfa, cqa, sa, uq, ulog/dxi
